...
export default function ContactPage() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      window.open(`mailto:h2b3@gmail.com?subject=${sub}&body=${body}`, '_blank');
        ...
        <div style={{ maxWidth:1100, margin:'0 auto',
          ...
          {[
            ...
            },
            {
              ...
              label:'Email Us', v1:'h2b3@gmail.com', v2:'Reply within 24 hours', href:'mailto:h2b3@gmail.com',
            },
            {
              icon: (
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#C9972B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:20 }}>
            ...
            <div style={{
              ...
              {[
                ...
                { label:'Email', value:'h2b3@gmail.com', href:'mailto:h2b3@gmail.com',
